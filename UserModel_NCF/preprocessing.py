...
class Preprocess:
    ...
    """
    def GenerateTrainingBatches(self, USER, itemObj, num_of_reviews = 5 , batch_size = 5, testing=False):
        print('start')
        ...
        for review_ctr in range(0, num_of_reviews, 1):
            ...
            for user_ctr in range(len(USER)):
                ...
                if(num_of_batch_group not in new_training_batch_asin):
            ...
            num_of_batch_group = 0
        return new_training_batches_asins
