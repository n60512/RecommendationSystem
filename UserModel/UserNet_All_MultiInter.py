...
def Train(myVoc, training_batches, candidate_asins, candidate_reviewerIDs, training_batch_labels, 
    ...
    for Epoch in range(TrainEpoch):
        ...
        Run multiple label for training HERE !!!! 
        """
        num_of_iter = len(training_batches[0])
...
#%%
training_batch_labels, candidate_asins, candidate_reviewerIDs = GenerateBatchLabelCandidate(training_labels, training_asins, training_reviewerIDs, batch_size)
validate_batch_labels, validate_asins, validate_reviewerIDs = GenerateBatchLabelCandidate(validation_labels, validation_asins, validation_reviewerIDs, batch_size)

training_batches = GenerateTrainingBatches(USER, num_of_reviews=num_of_reviews, batch_size=batch_size)
#%% Training
directory = '1111_lr1e06'
if(False):
